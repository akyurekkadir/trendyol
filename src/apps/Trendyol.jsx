  ...
  const renderCategoryContent = () => {
    ...
    if (activeTab === 'projeler') {
      items = [
        ...
        { title: 'IoT Smart Fridge', desc: 'Computer Vision ile Tüketim Takibi', icon: Box, tag: 'Embedded', badge: 'IoT', detail: 'Raspberry Pi ve OpenCV kullanılarak dolaptaki meyvelerin (elma, portakal vb.) durumunu (taze mi, çürük mü) tespit eden ve alışveriş listesi çıkaran yapay zeka destekli akıllı dolap uygulaması.', links: [{ text: 'GitHub', url: 'https://github.com/akyurekkadir/iot-smart-fridge' }, { text: 'YouTube', url: 'https://youtu.be/3ElFaKVzq6I' }] },
      ];
      ...
      items = [
        ...
        { title: 'Telenity AI & Data Engineering Intern', desc: 'Otomatik doküman analitiği, NLP ve Telekom API', icon: Briefcase, tag: 'Yaz Stajı', badge: 'STAJ', detail: 'Confluence API ile 17.000+ sayfalık veri redundancy analizi, Telekom sistemlerinde günde 300 binden fazla Event-Data pipeline inşası ve Arapça spam modelleri.' },
